...
urlpatterns = [
    ...
    path('upload-multiple/', views.upload_invoices, name='upload_invoices'),
    path('download-csv/', views.download_invoices_csv, name='download_invoices_csv'),
    
    # Authentication - only custom signup
